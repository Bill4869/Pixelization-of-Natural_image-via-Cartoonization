...
class PixelizationModel():
    ...
    def backward_all_net(self):
        ...
        self.loss_gridnet = loss_gridnet_IO_L1 + loss_gridnet_G_L1 + loss_mirror_B_1
        ...
        # L1 loss of PixelNet(added)	
        loss_pixelnet_IO_L2 = self.criterionL1(fake_B_x8_processed, self.real_A)	
        loss_pixelnet_IO_L2 += self.criterionL1(fake_B_x6_processed, self.real_A)	
        loss_pixelnet_IO_L2 += self.criterionL1(fake_B_x4_processed, self.real_A)	
        loss_pixelnet_IO_L2 *= lambda_weight / 20.0
        ...
        self.loss_pixelnet = loss_pixelnet_adversarial + loss_pixelnet_IO_L1 + loss_pixelnet_G_L1 + loss_pixelnet_IO_L2 + loss_mirror_B_2
    ...
    def get_current_visuals_test(self):
        ...
        ret_visuals = OrderedDict([('fake_B_x4_processed', fake_B_x4_processed)])
        return ret_visuals
